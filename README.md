...
| 성적 분석 | `/analytics` | 추이 그래프, 최근 공부 기록, 약점 과목, 예측 점수 |
| 캘린더 | `/calendar` | 시험·수행평가·과제 일정 등록 및 확인 |
| 맞춤전략 | `/strategy` | 성적·공부 기록·일정 기반 실행 계획 |
...
- 학습 동기 부여 수단으로 활용
- 생성된 AI 학습 피드백은 분석 리포트로 저장하여 재사용

### 8. 공부 기록 및 할 일 관리
- 실제 공부 시간, 난이도, 집중도 기록
- 공부 할 일 추가·수정·삭제·완료 처리
- 맞춤전략을 공부 할 일로 전환
...
**Main**
- [x] 성적 추이 그래프 (Phase 5)
- [x] 성적 분석 및 학습 전략 제공 (Phase 6)
- [x] AI 성적 예측 기능 (Phase 7)
- [x] 학업 캘린더 (Phase 8)
- [x] 대시보드 제작 (Phase 9)
- [x] 고등학생 전용 모의고사 페이지
